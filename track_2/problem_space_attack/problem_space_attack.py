...
class ProblemSpaceAttack:
    ...
    def run(self, malware_samples, goodware_samples, n_iterations=100,
        ...
        for i, sample in enumerate(malware_samples):
            ...
            label, score, adv_apk_path = self._run(sample)
            with open("track2_attack_results.csv", "a") as f:
                f.write("{},{},{}\n".format(label, score, adv_apk_path))
            results.append((label, score, adv_apk_path))
